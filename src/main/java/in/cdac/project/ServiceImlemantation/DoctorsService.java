...
import in.cdac.project.Action.repository.DoctorsRepository;
...
public Doctors AuthenticateDoctor(String drUsername, String drPassword) {
	Doctors doctor= doctorsRepository.findByDrUsernameAndDrPassword(drUsername, drPassword);
	if (doctor != null) {		
		return doctor;
	} else {
		return null;
	...
	//update dr status			
			...
			// @PostMapping("/updateDr")
				 public Doctors updateDr(String id,String drName,String drSpec,String drEmail,String drMobile,String drUsername,String drPassword,String hspId) {				   				   
