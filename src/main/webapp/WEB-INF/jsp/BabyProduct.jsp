			...
			<div class="col-4 mt-2">
				<div class="card">
					...
					<div class="card-body">
						...
						<p class="card-text">360° Front Wheel rotation with Swivel
			...
			<div class="col-4 mt-2">
				<div class="card">
					...
					<div class="card-body">
						...
						<p class="card-text">Anti Rash – India’s only diapers
			...
			<div class="col-4 mt-2">
				<div class="card">
					...
					<div class="card-body">
						...
						<p class="card-text">Soft booties for keeping your babyâ??s
